...
namespace TideDefense
{
    public class SeaManager : MonoBehaviour
    {
        ...
        [SerializeField] private Transform _seaTransform = null;


        #region Tide


        [SerializeField] private float _minTideLevel = 0f;
        [SerializeField] private float _maxTideLevel = 1f;
        ...
        /// Exprimé en m/s
        ///</summary>
        [SerializeField] private float _tideProgressSpeed = 0.2f;
        ...
        protected void CallbackUpdateCurrentDeltaTime(float currentDeltaTime)
        {
            ...
            _tidePhase = (bool)(1 - (int)Mathf.Floor(_tideProgress % 2));
